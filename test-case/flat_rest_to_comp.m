...
% Channel without Orography Initial Conditions
...
% 计算垂直坐标 
eta_c = 0.2; % critical eta：对于30km模式顶一般取0.2
...
eta_start = 0.0;
eta_half = linspace(eta_start, 1.0, NLEV_half);
