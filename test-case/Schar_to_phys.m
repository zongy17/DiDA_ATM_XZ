...
w = load("../cmake-build-release/schar_10h_1.0s_K不迎风_位温1.0_水平250m_隐式R耗散_无水平和三维散度耗散/w_36000.00s.dat");
u = load("../cmake-build-release/schar_10h_1.0s_K不迎风_位温1.0_水平250m_隐式R耗散_无水平和三维散度耗散/u_36000.00s.dat") - 10;
gz= load("../cmake-build-release/schar_10h_1.0s_K不迎风_位温1.0_水平250m_隐式R耗散_无水平和三维散度耗散/gz_36000.00s.dat");
u_ns = load("../cmake-build-release/schar_10h_1.0s_K不迎风_位温1.0_水平250m_隐式R耗散_无水平和三维散度耗散/u_ns_36000.00s.dat") - 10;

x_full = load("../cmake-build-release/schar_10h_1.0s_K不迎风_位温1.0_水平250m_隐式R耗散_无水平和三维散度耗散/x_full.dat");
eta_full =load("../cmake-build-release/schar_10h_1.0s_K不迎风_位温1.0_水平250m_隐式R耗散_无水平和三维散度耗散/eta_full.dat");
x_half= load("../cmake-build-release/schar_10h_1.0s_K不迎风_位温1.0_水平250m_隐式R耗散_无水平和三维散度耗散/x_half.dat");
eta_half =load("../cmake-build-release/schar_10h_1.0s_K不迎风_位温1.0_水平250m_隐式R耗散_无水平和三维散度耗散/eta_half.dat");
