...
NX_full = 360; NLEV_full = 102; % non-hydrostatic
...
hc = 10.0; xc = 0.0; ac = 2.0e3; % non-hydrostatic
...
% domain size
x_lo = -72.0e3; x_hi = 72.0e3; % non-hydrostatic
ph_top_set = 0.0;
...
% 计算垂直坐标 
eta_c = 0.1; % 模式顶部的eta：对于30km模式顶一般取0.2
...
z_top_set = 25.0e3; % non-hydrostatic
trunc_lev = NLEV_half;
for k = 1:1:NLEV_half
    if z(k,1) < z_top_set
        trunc_lev = k;
...
zh = z_top_calc - 13.0e3; tau_0 = 20.0; % non-hydrostatic
